CREATE OR REPLACE FUNCTION public.ampractconvval_configura_duplica(pfiltros character varying)
 RETURNS boolean
 LANGUAGE plpgsql
...
,apvidusuario
,apidasocconv) (
SELECT idnomenclador,idcapitulo,idsubcapitulo,idpractica,pdescripcion as apvdescripcionpractica,rfiltros.apviniciovigencia as apviniciovigencia
