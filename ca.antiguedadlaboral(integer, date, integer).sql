CREATE OR REPLACE FUNCTION ca.antiguedadlaboral(integer, date, integer)
 RETURNS integer
 LANGUAGE plpgsql
...
from age((( date_trunc('month', concat(rliquidacion.lianio,'-',rliquidacion.limes,'-1')::date) + interval '1 month') - interval
'1 day')::date,

--to_timestamp(concat(rliquidacion.lianio ,'-',rliquidacion.limes,'-31'),'YYYY-MM-DD'),
