CREATE OR REPLACE FUNCTION public.far_traercoberturasarticuloafiliado_nueva(character varying, bigint, bigint, bigint, integer, bigint, integer, integer)
...
AS $function$/* $1 vmnroregistro - $2 vidafiliadoos - $3 vidafiliadososunc - $4 vidafiliadoamuc -$5 vidvalidacion
   $6 vidafiliadoom - $7 vidmutual - $8 vidcentrovalidacion
...
LEFT JOIN far_validacion AS fv ON(fincodigo =1 AND idvalidacion = $5  AND idcentrovalidacion = $8)	
