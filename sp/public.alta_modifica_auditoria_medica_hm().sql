CREATE OR REPLACE FUNCTION public.alta_modifica_auditoria_medica_hm()
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$DECLARE
  respuesta BOOLEAN;
 ...
 /* Modifica la emision pendiente*/
     UPDATE fichamedicaemision
                      ...
                      --  ,idauditoriatipo = elem.idauditoriatipo
                        ...
                        -- BelenA agrego que se actualice la fecha del vencimiento 23/07/24
                        ,fmefechavto=elem.fmefechavto
                WHERE idfichamedicaitem = elem.idfichamedicaitem  AND idcentrofichamedicaitem = elem.idcentrofichamedicaitem;
...
--KR 15-02-22 LA fecha se toma de la ventana
                ,elem.fmefechavto
