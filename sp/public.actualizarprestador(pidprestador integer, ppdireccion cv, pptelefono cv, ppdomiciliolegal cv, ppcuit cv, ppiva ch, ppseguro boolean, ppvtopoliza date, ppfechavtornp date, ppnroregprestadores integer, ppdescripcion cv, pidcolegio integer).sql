...
begin
      respuesta=0;
      select into xMapeo * from mapeoprestadores where idprestadormultivac = pidprestador;
      if not found then --No existe una tupla en Mapeos para el Prestador ingresado --> Insertar uno Nuevo
         ...
         if not found then -- No existe un prestador en Siges con el mismo idprestador y cuit que en Multivac
            ...
            INSERT INTO prestadorctacte(idprestador)VALUES(auxN); -- vas 31/08/2017
            idSigesNuevo=auxN;
         ...
         INSERT INTO mapeoprestadores (idprestadormultivac,idprestadorsiges,cuitmultivac)
