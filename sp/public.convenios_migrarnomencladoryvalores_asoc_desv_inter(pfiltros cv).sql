CREATE OR REPLACE FUNCTION public.convenios_migrarnomencladoryvalores_asoc_desv_inter(pfiltros character varying)
...
--Agrego Coseguro, pues siempre deberia estar
rfiltros.asociaciones_siges = concat(rfiltros.asociaciones_siges,'@','154');
