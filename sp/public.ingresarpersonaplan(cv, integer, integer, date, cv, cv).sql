CREATE OR REPLACE FUNCTION public.ingresarpersonaplan(character varying, integer, integer, date, character varying, character varying)
 RETURNS boolean
 LANGUAGE plpgsql
       ...
       elnrodoc = $1;
        ...
        IF NOT nullvalue(elidplan )THEN
               ...
               IF NOT FOUND THEN -- La persona no esta vinculada al plan
                    ...
                    VALUES ( elnrodoc, eltipodoc, elidplan, dechainicioplan, elidplan, dechainicioplan,detalleinforme,resumeninforme);
               ELSE
