CREATE OR REPLACE FUNCTION public.padronamuc_baja_afiliauto(argtipodoc integer, argnrodoc character varying)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
declare
...
begin
select into afil * from afiliauto natural join persona where nrodoc=argnrodoc and tipodoc=argtipodoc;
if not afil.mutu then
          ...
          update afiliauto set mutu=false where nrodoc=argnrodoc and tipodoc=argtipodoc;
