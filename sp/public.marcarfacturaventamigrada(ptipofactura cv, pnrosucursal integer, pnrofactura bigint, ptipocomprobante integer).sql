CREATE OR REPLACE FUNCTION public.marcarfacturaventamigrada(ptipofactura character varying, pnrosucursal integer, pnrofactura bigint, ptipocomprobante integer)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
declare
...
FETCH rs into aux;
while found loop
   insert into facturaventa_migrada(tipocomprobante,nrosucursal,nrofactura,centro,tipofactura,iditem,fechamigracion)
