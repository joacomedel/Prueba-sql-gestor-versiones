CREATE OR REPLACE FUNCTION public.recalcularvaloresconcepto()
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$/*
                      ...
                      IF (unconcepto.idconceptotipo = 11 ) THEN
                            ...
                            -- por lo que hay que ejecutar la formula a la que referencian
                             ...
                             IF(unconcepto.idformula=8 or unconcepto.idformula=10 or
                                unconcepto.idformula=39 or unconcepto.idformula=13 )THEN
...
--or unconcepto.idconcepto=1145
                 ...
                 ELSE
                     ...
                     IF (unconcepto.idconcepto=1 or unconcepto.idconcepto=17 or unconcepto.idconcepto=33
                          or unconcepto.idconcepto=27 ) THEN
                           f =laformula;
                          RAISE NOTICE 'aca (%)',laformula;
                      ELSE
          ...
          RAISE NOTICE 'FROMUKA  del execute f (%)',f;
          EXECUTE  f;
