CREATE OR REPLACE FUNCTION ca.as_syjapagarasistenncial(integer, integer)
...
BEGIN
  ...
  */
    ...
    select into montoctacteasist ca.as_conceptoasiento(elmes,elanio,387);
     
     select into montocuotaplanpago ca.as_conceptoasiento(elmes,elanio,374);

     montototal = montoctacteasist + montocuotaplanpago;
   
     montototal =  round(montototal::numeric,3);
