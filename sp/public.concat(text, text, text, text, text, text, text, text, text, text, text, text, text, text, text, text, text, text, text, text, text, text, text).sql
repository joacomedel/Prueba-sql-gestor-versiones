CREATE OR REPLACE FUNCTION public.concat(text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text)
 RETURNS text
 LANGUAGE plpgsql
 IMMUTABLE
AS $function$ 
