CREATE OR REPLACE FUNCTION public.far_abmarticuloubicacionsucursal(pidarticulo bigint, pidcentroarticulo integer, pidubicacionsucursal integer, pidcentroubicacionsucursal integer)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
declare
...
begin
     ...
     IF NOT FOUND THEN 
	INSERT INTO far_articuloubicacionsucursal(idubicacionsucursal,idcentroubicacionsucursal,idarticulo,idcentroarticulo)
