CREATE OR REPLACE FUNCTION public.far_traerinfocoberturascoseguro_val()
    ...
    */
    ...
    FOR rcobinfomedi IN 
        SELECT    idobrasocial,
                  ...
                  idrubro ,
                  adescripcion ,
                  --CASE WHEN (idobrasocial=1 AND  importeunitario!=0) THEN importeunitario ELSE precio END as precio,
                  precio,
                  rdescripcion ,
                  astockmin ,
                  astockmax ,
        ...
        FROM 
            (
                SELECT *
                FROM far_traercoberturascoseguroarticuloafiliado(vmnroregistro,vidafiliadoos,vidafiliadososunc,vidafiliadoamuc,vidvalidacion,vidafiliadomutual,vquemutual,vidcentrovalidacion)
            ) as coberturas
