CREATE OR REPLACE FUNCTION public.farmacia_ventasxhora_resumen_contemporal(character varying)
...
BEGIN
     ...
     CREATE TEMP TABLE temp_farmacia_ventasxhora_resumen_contemporal AS (

              SELECT 
                --date_trunc('day',ovfechaemision)::date  as fechaemision 
                count(*) as cantidadorden
                ,extract(hour from ovfechaemision) as hora
                --,cob
