CREATE OR REPLACE FUNCTION ca.as_conceptoasiento(integer, integer, integer, integer, integer, integer)
...
from ca.conceptoempleado 
	natural join ca.liquidacion
		...
		(idconcepto=',elconcepto1,'or idconcepto=',elconcepto2, ' or idconcepto=',elconcepto3,' or idconcepto=',elconcepto4,') and limes=',elmes,' and lianio=',elanio);
