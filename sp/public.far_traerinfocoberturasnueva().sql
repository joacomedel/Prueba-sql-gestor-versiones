CREATE OR REPLACE FUNCTION public.far_traerinfocoberturasnueva()
    ...
    */
    ...
    for rcobinfomedi in 
        SELECT 
              ...
              /*case when nullvalue(rarticulo.cantvendida) 
              THEN 
                CASE WHEN nullvalue(vi.cantidadaprobada) 
                THEN 0 ELSE 
                    CASE WHEN vi.cantidadaprobada>restante THEN restante ELSE vi.cantidadaprobada END  
                END 
              ELSE 
                CASE WHEN rarticulo.cantvendida>restante THEN restante ELSE  rarticulo.cantvendida END 
