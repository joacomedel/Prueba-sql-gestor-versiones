CREATE OR REPLACE FUNCTION public.agregaraportes_sosunc_unafil()
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$/*
...
AND  (
((idconcepto=202) AND nullvalue(dh21.nroconcepto))
or
...
AND  (
((idconcepto=202) AND nullvalue(dh49.nrocargo))
or
   ((datoscategoria.idcategoria=21)and idconcepto=1232)-- esto es para tener en cuenta los pasantes
   )
;
