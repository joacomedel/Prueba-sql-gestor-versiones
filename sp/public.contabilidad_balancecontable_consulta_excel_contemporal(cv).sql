CREATE OR REPLACE FUNCTION public.contabilidad_balancecontable_consulta_excel_contemporal(character varying)
...
BEGIN
     ...
     respuesta = '';
        ...
        CREATE TEMP TABLE temp_contabilidad_balancecontable_consulta_excel_contemporal_h1 AS (
            SELECT  
               CASE
...
/*-- Ordena primero por Rubro y despues por nrocuentac
        ...
        CREATE TEMP TABLE temp_contabilidad_balancecontable_consulta_excel_contemporal_h2 AS (
            SELECT  
               CASE
                      WHEN hiigrupo = 'ACTIVO' THEN 1
                      WHEN hiigrupo = 'PASIVO' THEN 2
...
/*-- Ordena primero por Rubro y despues por nrocuentac
        ...
        CREATE TEMP TABLE temp_contabilidad_balancecontable_consulta_excel_contemporal_h3 AS (
            SELECT  
               CASE
                      WHEN hiigrupo = 'ACTIVO' THEN 1
                      WHEN hiigrupo = 'PASIVO' THEN 2
...
/*-- Ordena primero por Rubro y despues por nrocuentac
      ...
      CREATE TEMP TABLE temp_contabilidad_balancecontable_consulta_excel_contemporal as (
        SELECT '1-Datos_Completos' as titulohoja,'temp_contabilidad_balancecontable_consulta_excel_contemporal_h3' as nombretabla 
          UNION 
        SELECT '2-Saldos' as titulohoja,'temp_contabilidad_balancecontable_consulta_excel_contemporal_h1' as nombretabla
          UNION 
        SELECT '3-Saldos_Reexpresados' as titulohoja,'temp_contabilidad_balancecontable_consulta_excel_contemporal_h2' as nombretabla
      );
