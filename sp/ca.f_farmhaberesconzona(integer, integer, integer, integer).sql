CREATE OR REPLACE FUNCTION ca.f_farmhaberesconzona(integer, integer, integer, integer)
...
SELECT INTO  elmonto SUM(cemonto*ceporcentaje)
	...
	(idconceptotipo = 1 OR idconceptotipo =7 OR idconceptotipo =2 OR  idconceptotipo = 5 OR
	idconceptotipo =10  or idconcepto=1051 or idconcepto=1199 or idconcepto=1218) and
	idliquidacion= $1;
return 	elmonto;
END;
