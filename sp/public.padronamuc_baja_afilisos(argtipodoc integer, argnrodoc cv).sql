CREATE OR REPLACE FUNCTION public.padronamuc_baja_afilisos(argtipodoc integer, argnrodoc character varying)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
declare
...
begin
select into afil * from afilisos natural join persona where nrodoc=argnrodoc and tipodoc=argtipodoc;
if not afil.mutu then
          ...
          update afilisos set mutu=false where nrodoc=argnrodoc and tipodoc=argtipodoc;
