CREATE OR REPLACE FUNCTION public.agregaraportesparaunafiliado(bigint, integer, integer)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
/*
...
pues se usa este sp para cargar aportes retroactivos.*/
                    ...
                    WHERE dh21.mesingreso = $2
	                      AND dh21.anioingreso = $3
...
SELECT INTO rliquidacion
       ...
       FROM dh49 WHERE dh49.nroliquidacion = elemcursor.nroliquidacion
        and dh49.mesingreso = $2
	                      AND dh49.anioingreso = $3
