CREATE OR REPLACE FUNCTION public.padronamuc_alta_afilirecurprop(argtipodoc integer, argnrodoc character varying)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
declare
...
if afil.mutu then
          ...
          update afilirecurprop set mutu=true where nrodoc=argnrodoc and tipodoc=argtipodoc;
