CREATE OR REPLACE FUNCTION public.contabilidad_balancecontable_consultacompleta_contemporal(character varying)
...
BEGIN
    ...
    -- Hace el calculo e insert en la tabla de los indices. 
     PERFORM contabilidad_balancecontable_mensual_indicexinflacion(concat('idejerciciocontable=',rparam.idejerciciocontable));
        ...
        CREATE TEMP TABLE temp_contabilidad_balancecontable_consultacompleta_contemporal_h1 AS (
            SELECT  
               CASE
               ...
               ORDER BY  -- Ordena primero por Rubro y despues por nrocuentac
                      CASE
                             WHEN hiigrupo = 'ACTIVO' THEN 1
                             WHEN hiigrupo = 'PASIVO' THEN 2
                             WHEN hiigrupo = 'PATRIMONIO NETO' THEN 3
        ...
        CREATE TEMP TABLE temp_contabilidad_balancecontable_consultacompleta_contemporal_h2 AS (
            SELECT  
               CASE
                      WHEN hiigrupo = 'ACTIVO' THEN 1
                      WHEN hiigrupo = 'PASIVO' THEN 2
        ...
        CREATE TEMP TABLE temp_contabilidad_balancecontable_consultacompleta_contemporal_h3 AS (
            SELECT  
               CASE
                      WHEN hiigrupo = 'ACTIVO' THEN 1
                      WHEN hiigrupo = 'PASIVO' THEN 2
      ...
      CREATE TEMP TABLE temp_contabilidad_balancecontable_consultacompleta_contemporal as (
        SELECT 'Datos_Completos' as titulohoja,'temp_contabilidad_balancecontable_consultacompleta_contemporal_h3' as nombretabla 
          UNION 
        SELECT 'Saldos' as titulohoja,'temp_contabilidad_balancecontable_consultacompleta_contemporal_h1' as nombretabla
          UNION 
        SELECT 'Saldos_Reexpresados' as titulohoja,'temp_contabilidad_balancecontable_consultacompleta_contemporal_h2' as nombretabla
      );
