CREATE OR REPLACE FUNCTION public.padronamuc_baja_afilirecurprop(argtipodoc integer, argnrodoc character varying)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
declare
...
begin
select into afil * from afilirecurprop natural join persona where nrodoc=argnrodoc and tipodoc=argtipodoc;
if not afil.mutu then
          ...
          update afilirecurprop set mutu=false where nrodoc=argnrodoc and tipodoc=argtipodoc;
