CREATE OR REPLACE FUNCTION public.cambiarestadosregistros(integer, integer, integer)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$DECLARE
...
BEGIN
  ...
  INSERT INTO festados (fechacambio,nroregistro,anio,tipoestadofactura,observacion) VALUES 
                               (CURRENT_DATE,$1,$2,$3,'Desde SP cambiarestadosregistros');
   ...
   WHILE  found LOOP
             ...
             INSERT INTO festados (fechacambio,nroregistro,anio,tipoestadofactura,observacion) VALUES 
                                 (CURRENT_DATE,unresumen.nroregistro,unresumen.anio,$3,'Desde SP cambiarestadosregistros');
                     FETCH losresumenes INTO unresumen;
    END LOOP;
    CLOSE losresumenes;
...
IF FOUND THEN
       ...
       IF NOT FOUND THEN --PASO EL RESUMEN AL estado correspondiente
	    ...
	    VALUES (CURRENT_DATE,elresumen.idresumen,elresumen.anioresumen,$3,'Desde SP cambiarestadosregistros');
