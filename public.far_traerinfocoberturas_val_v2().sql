CREATE OR REPLACE FUNCTION public.far_traerinfocoberturas_val_v2()
    ...
    */
    ...
    FOR rcobinfomedi IN 
        ...
        FROM 
            (
                SELECT *
                FROM far_traercoberturasarticuloafiliado_3(vmnroregistro,vidafiliadoos,0,0,vidvalidacion,0,0,vidcentrovalidacion)
            ) as coberturas
