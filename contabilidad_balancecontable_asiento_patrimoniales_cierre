CREATE OR REPLACE FUNCTION public.contabilidad_balancecontable_asiento_patrimoniales_cierre(pfiltros character varying)
...
BEGIN
---SELECT contabilidad_balancecontable_asiento_patrimoniales_cierre('{idejerciciocontable=8}')
       salida = false;
	   diferencia = 0;
