CREATE OR REPLACE FUNCTION ca.cantdiaslaborablesemp(date, date, integer)
 RETURNS integer
 LANGUAGE plpgsql
AS $function$/*
...
BEGIN
     ...
     cantdiasrango = $2 - $1;
     indicefecha = $1;
	 select into grupo * from ca.grupoliquidacionempleado where idpersona=$3;
     FOR indice IN 0..cantdiasrango LOOP
             ...
             dia = to_char(indicefecha,'d');
                ...
                if (dia <>7 and  dia <> 1 ) or (grupo=2 and dia<>1)THEN
