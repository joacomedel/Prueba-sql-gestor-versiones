CREATE OR REPLACE FUNCTION public.eliminartablasincronizable_anterior(tablaasincronizar text)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
declare
...
begin
    ...
    nombretrigger2 := concat('ai' , tablaasincronizar);
