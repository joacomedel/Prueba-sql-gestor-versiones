CREATE OR REPLACE FUNCTION ca.f_valorconceptofijososunc(integer, integer, integer, integer)
...
--Dani agrega 29112023 para que calcule el proporcional en caso de jornada reducida
