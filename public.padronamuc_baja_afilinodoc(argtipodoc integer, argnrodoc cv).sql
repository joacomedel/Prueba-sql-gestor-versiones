CREATE OR REPLACE FUNCTION public.padronamuc_baja_afilinodoc(argtipodoc integer, argnrodoc character varying)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
declare
...
if not afil.mutu then
          ...
          update afilinodoc set mutu=false where nrodoc=argnrodoc and tipodoc=argtipodoc;
