CREATE OR REPLACE FUNCTION ca.as_syjapagarprestamoasistenncial(integer, integer)
...
BEGIN
  ...
  */
     ...
     select into montoctaprestamasist ca.as_conceptoasiento(elmes,elanio,373);

    
     montototal =  round(montoctaprestamasist::numeric,3);
