CREATE OR REPLACE FUNCTION ca.planillamensualasistencia(date, date, bigint)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
/*
...
CREATE  TEMP TABLE temporalmas(
codigopersona integer ,
penombre  varchar, peapellido varchar,
documento varchar,
cantdiaslaborales integer,
cantdiastrabajados integer,
cantdiasausentes integer,
ltdescripcion varchar ,
cantdiashorario integer,
cantentradatolerancia integer,
cantentradadespuestolerancia integer,
