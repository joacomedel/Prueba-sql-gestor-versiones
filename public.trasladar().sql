...
BEGIN
     ...
     WHILE found LOOP
                   ...
                   OPEN curitem for SELECT
                    ...
                    WHERE r.idasiento = rasientorev.idasiento AND rasientorev.codcuentaorigen = idcuenta ;
	 ...
	 UPDATE asientotrasladar SET generado = now() WHERE idasientorevertir = rasientorev.idasientotrasladar;
