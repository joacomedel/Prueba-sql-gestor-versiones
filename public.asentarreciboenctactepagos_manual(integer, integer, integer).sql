CREATE OR REPLACE FUNCTION public.asentarreciboenctactepagos_manual(integer, integer, integer)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$/*
...
WHERE 
                      ...
                      idpv2.legajosiu in (55628) AND 
--04-10-2018 MALAPI: NO DEJAR PARAMETROS CABLEADOS.
                        idpv2.mes =11 AND idpv2.anio=2024
