CREATE OR REPLACE FUNCTION public.crearinformefacturacion(character varying, bigint, integer)
 RETURNS integer
 LANGUAGE plpgsql
AS $function$/*
...
BEGIN
	...
	INSERT INTO informefacturacionestado(idinformefacturacionestadotipo,nroinforme,idcentroinformefacturacion,fechaini,descripcion)
        VALUES(1,idnroinforme,centro(),now(),'Generado Automaticamente desde crearinformefacturacion');
