CREATE OR REPLACE FUNCTION public.far_reemitircomprobantenoemitido(bigint, integer, integer, character varying, integer)
...
importesosunc,importeefectivo,importedebito,importectacte,importecredito,importeamuc)
   ...
   (
    ...
    /** Vuelvo las ordenes a pendientes de facturacion */
     ...
     OPEN cfar_ordenventa FOR
          ...
          WHERE nrofactura = elem.sgtenumero  and tipofactura=ptipofactura and tipocomprobante =ptipocomprobante
     ...
     /*  GUARDAN LOS CUPONES */
      ...
      (SELECT  elem.sgtenumero, tipocomprobante, elem.nrosucursal, tipofactura,
       ...
       WHERE
         ...
         INSERT INTO facturaventausuario (tipocomprobante,
         nrosucursal,nrofactura,tipofactura,idusuario)
         (SELECT tipocomprobante, elem.nrosucursal, elem.sgtenumero,tipofactura,idusuario
