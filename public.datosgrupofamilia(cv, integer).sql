CREATE OR REPLACE FUNCTION public.datosgrupofamilia(character varying, integer)
 RETURNS refcursor
 LANGUAGE plpgsql
AS $function$DECLARE
	datosafil REFCURSOR;
...
select into datotitu nrodoc as nrodoctitu,tipodoc as tipodoctitu
  ...
  --DAni modifico el 10/09/2014 para q traiga las vigentes q no esten dadas de baja
