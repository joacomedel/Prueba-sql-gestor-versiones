CREATE OR REPLACE FUNCTION public.far_guardarordenventaitemvale(bigint, integer, bigint, integer)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$DECLARE
...
BEGIN
              ...
              WHILE  found LOOP
                     ...
                     IF FOUND THEN 
                        INSERT INTO far_ordenventaitemvale(idordenventaitemvale,idcentroordenventaitemvale,idordenventaitemoriginal,idcentroordenventaitemoriginal)
