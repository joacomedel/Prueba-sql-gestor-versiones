CREATE OR REPLACE FUNCTION public.w_registrarvalidacionissn(parametro jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
...
--[0] => {"Mutuales":[{"CodigoMutual":12,"Nombre":"MUPOL","Porcentaje":20,"Aplica":"C"}]}
	...
	INSERT INTO far_validacionissn( fvrespuesta,fvnumeroautorizacion,fvmodalidad)
	VALUES (
		parametro,
