CREATE OR REPLACE FUNCTION multivac.marcarfacturaventamigrada_p(ptipofactura character varying, pnrosucursal integer, pnrofactura bigint, ptipocomprobante integer)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$declare
rta boolean;
